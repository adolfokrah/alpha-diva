...
function App(props){
    ...
    const [bac_holder_name, setbac_holder_name] = useState(props.user.bac_holder_name);
    const [name_of_bank, setname_of_bank] = useState(props.user.name_of_bank);
    const [bank_acc, setbank_acc] = useState(props.user.bank_acc);
    const [bank_sort_code, setbank_sort_code] = useState(props.user.bank_sort_code);

    const [address_one, setaddress_one] = useState(props.user.address_one);
    const [town, settown] = useState(props.user.town);
    const [address_two, setaddress_two] = useState(props.user.address_two);
    const [postal_code, setpostal_code] = useState(props.user.postal_code);
    ...
    async function update(){
        ...
        if(bac_holder_name.trim().length > 0 && name_of_bank.trim().length > 0 && bank_acc.trim().length>0 && bank_sort_code > 0  && phone.trim().length > 0 && email.trim().length > 0){
            ...
            if(password.toUpperCase() === name_of_bank.toUpperCase() || password.toUpperCase() === bac_holder_name.toUpperCase() ){
                    seterror(true);
                    seterrorMessage("Oops! Password cannot be the same as your bank name or bank holder name");
                    return; 
            }
            ...
            data.bac_holder_name = bac_holder_name;
            data.name_of_bank = name_of_bank;
            data.bank_acc = bank_acc;
            data.bank_sort_code = bank_sort_code;
            data.email = email;
            data.phone = phone;
           ...
           try {
            ...
            if(request.status === 200){
              ...
              seterror(true);
              seterrorMessage("Oops! business email already exist");
             }else{
                seterror(true);
    ...
    return(
        <Box>
            ...
            <h3 style={{marginTop:30}}>Payemnt Details</h3>
            ...
            <Box style={{marginTop:50}}>
                ...
                <Grid  container spacing={1} style={{marginTop:20}} alignItems="flex-end">
                  ...
                  <Grid item xs={10} sm={11}>
                    <WhiteTextField label="Bank Holder Name" onChange={(e)=>{setbac_holder_name(e.target.value)}} value={bac_holder_name} fullWidth/>
                  </Grid>
                </Grid>
                ...
                <Grid  container spacing={1} style={{marginTop:20}} alignItems="flex-end">
                  ...
                  <Grid item xs={10} sm={11}>
                    <WhiteTextField label="Name of Bank" onChange={(e)=>{setname_of_bank(e.target.value)}} value={name_of_bank} fullWidth/>
                  </Grid>
                </Grid>
                ...
                <Grid  container spacing={1} style={{marginTop:20}} alignItems="flex-end">
                  ...
                  <Grid item xs={10} sm={11}>
                    <WhiteTextField label="Bank Account Number" onChange={(e)=>{setbank_acc(e.target.value)}} value={bank_acc} fullWidth/>
                  </Grid>
                </Grid>
                <Grid  container spacing={1} style={{marginTop:20}} alignItems="flex-end">
                  <Grid item>
                    <Icon className={classes.icon}>format_list_numbered_rtl</Icon>
                  </Grid>
                  <Grid item xs={10} sm={11}>
                    <WhiteTextField label="Bank Sort Code" onChange={(e)=>{setbank_sort_code(e.target.value)}} value={bank_sort_code} fullWidth/>
                  </Grid>
                </Grid>
            ...
            <h3 style={{marginTop:60}}>Bank/Building Society branch address (optional)</h3>
            <Box style={{marginTop:50}}>
                ...
                <Grid  container spacing={1} style={{marginTop:20}} alignItems="flex-end">
                  ...
                  <Grid item xs={10} sm={11}>
                    <WhiteTextField label="Address Line 1" onChange={(e)=>{setaddress_one(e.target.value)}} value={address_one} fullWidth/>
                  </Grid>
                </Grid>
                ...
                <Grid  container spacing={1} style={{marginTop:20}} alignItems="flex-end">
                  ...
                  <Grid item xs={10} sm={11}>
                    <WhiteTextField label="Address Line 2" onChange={(e)=>{setaddress_two(e.target.value)}} value={address_two} fullWidth/>
                  </Grid>
                </Grid>
                ...
                <Grid  container spacing={1} style={{marginTop:20}} alignItems="flex-end">
                  ...
                  <Grid item xs={10} sm={11}>
                    <WhiteTextField label="Town or City" onChange={(e)=>{settown(e.target.value)}} value={town} fullWidth/>
                  </Grid>
                </Grid>
                ...
                <Grid  container spacing={1} style={{marginTop:20}} alignItems="flex-end">
                  ...
                  <Grid item xs={10} sm={11}>
                    <WhiteTextField label="Postal Code" onChange={(e)=>{setpostal_code(e.target.value)}} value={postal_code} fullWidth/>
                  </Grid>
                </Grid>
